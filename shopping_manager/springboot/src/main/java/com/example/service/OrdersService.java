...
public class OrdersService {
    ...
    public void add(Orders orders) {
        ...
        for (Cart cart : orders.getCartData()) {
            ...
            dbOrders.setProductId(cart.getProductId());
            dbOrders.setSellerId(cart.getSellerId());
            dbOrders.setNum(cart.getNum());
            dbOrders.setPrice(cart.getNum() * cart.getProductPrice());
    ...
    public PageInfo<Orders> selectPage(Orders orders, Integer pageNum, Integer pageSize) {
        ...
        if (RoleEnum.SELLER.name().equals(currentUser.getRole())) {
            orders.setSellerId(currentUser.getId());
        }
