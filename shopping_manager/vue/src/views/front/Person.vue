<template>
  <div class="main-content">
    <el-card style="width: 50%; margin: 4px auto">
    ...
    <el-dialog title="Modify Password" :visible.sync="dialogVisible" width="30%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="user" label-width="80px" style="padding-right: 20px" :rules="rules" ref="formRef">
        <el-form-item label="Old" prop="password">
          <el-input show-password v-model="user.password" placeholder="Old"></el-input>
        </el-form-item>
        <el-form-item label="New" prop="newPassword">
          <el-input show-password v-model="user.newPassword" placeholder="New"></el-input>
        </el-form-item>
        <el-form-item label="Again" prop="confirmPassword">
          <el-input show-password v-model="user.confirmPassword" placeholder="Again"></el-input>
        </el-form-item>
      </el-form>
