<template>
  <div>
    ...
    <el-dialog title="Category" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        title: [
          {required: true, name: 'Please enter name', trigger: 'blur'},
        ],
        content: [
          {required: true, img: 'Please upload icon', trigger: 'blur'},
        ]
      },
      ids: []
    }
